...
def main(args):
    ...
    sys.stdout = Logger(filename=os.path.join(cwd, 'train_densenet.log'))

    data_path = os.path.join(cwd, 'data')
    image_path = os.path.join(data_path, 'npy_data')
    save_path = os.path.join(cwd, 'saved_models', 'densenet')
    res_path = os.path.join(cwd, 'results', 'densenet')
