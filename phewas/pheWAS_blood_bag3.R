...
df_expo <- read_exposure_data('eqtls_bag3/significant_blood_eqtls.csv',
                              sep = ',',
...
write.csv(res_all, 'results_bag3/phwas_res_blood.csv', row.names = F)
write.csv(res_pleiotropy, 'results_bag3/pleiotropy_res_blood.csv', row.names = F)
