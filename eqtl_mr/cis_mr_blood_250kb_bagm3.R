...
df <- read.csv('data_250kb_eqtls/druggable_blood_eqtls.csv')
...
write.csv(res_all, 'results_250kb_eqtls_bagm3/mr_res_blood.csv', row.names = F)
write.csv(res_pleiotropy, 'results_250kb_eqtls_bagm3/pleiotropy_res_blood.csv', row.names = F)
