...
from model.efficientnet3D import EfficientNet3D
...
def main(args):
    ...
    sys.stdout = Logger(filename=os.path.join(cwd, 'train_efficientnet.log'))

    data_path = os.path.join(cwd, 'data')
    image_path = os.path.join(data_path, 'npy_data')
    save_path = os.path.join(cwd, 'saved_models', 'efficientnet')
    res_path = os.path.join(cwd, 'results', 'efficientnet')
