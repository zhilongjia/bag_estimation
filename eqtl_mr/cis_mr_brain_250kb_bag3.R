...
write.csv(res_all, 'results_250kb_eqtls_bag3/mr_res_brain.csv', row.names = F)
write.csv(res_pleiotropy, 'results_250kb_eqtls_bag3/pleiotropy_res_brain.csv', row.names = F)
